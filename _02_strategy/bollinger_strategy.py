...
def run_bolling_list(start_date="2015-01-01", end_date="2019-12-31", initial_cash=100000):
    db = get_mongo_client()
    ...
    for stock_id in collections:
        backtest = BollingerBandStrategy(stock_id=stock_id, start_date=start_date, end_date=end_date, initial_cash=initial_cash, label=label)
